...
contract Down is IIndicator {
    ...
    */
    function addTradingBot(uint index, uint param) public pure override {}
    ...
    */
    function getValue(address tradingBotAddress, uint index) public pure override returns (uint[] memory) {
    ...
    */
    function getHistory(address tradingBotAddress, uint index) public pure override returns (uint[] memory) {
        return new uint[](0);
    }
}