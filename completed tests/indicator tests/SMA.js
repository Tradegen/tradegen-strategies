...
var contractAddress = "0x465a2fa8C73A087Be82c310517dEcFFe13924dD6";
...
{ 
    ...
    it('Add second instance of first trading bot', async () => {
        ...
        assert(
            history[2] == 2000,
            'Third element in history should be 2000'
        );

        assert(
            history[3] == 3000,
            'Fourth element in history should be 3000'
        );
    });
