...
var contractAddress = "0xa79F1B4021eD6719FA3C4E11fcA297bc980a4303";
...
{ 
    ...
    it('Add second instance of first trading bot', async () => {
        ...
        assert(
            ...
            'First element in current value array should be 1000'
        );

        assert(
            currentValue3[1] == 2000,
            'Second element in current value array should be 2000'
        );

        assert(
            currentValue3[2] == 3000,
            'Third element in current value array should be 3000'
        );
        ...
        assert(
            ...
            'First element in current value array should be 2000'
        );

        assert(
            currentValue4[1] == 3000,
            'Second element in current value array should be 3000'
        );

        assert(
            currentValue4[2] == 4000,
            'Third element in current value array should be 4000'
        );
